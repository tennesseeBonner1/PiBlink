...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.trialGridLayout.setSpacing(0)
        self.trialGridLayout.setObjectName("trialGridLayout")
        self.verticalLayout.addLayout(self.trialGridLayout)
        self.masterVerticalLayout.addWidget(self.gridWidget)
