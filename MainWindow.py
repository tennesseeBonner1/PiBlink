...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("Images/Previous_Button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.previousButton.setIcon(icon13)
        self.previousButton.setIconSize(QtCore.QSize(100, 75))
        self.previousButton.setObjectName("previousButton")
        self.graphButtonLayout.addWidget(self.previousButton)
        spacerItem13 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.graphButtonLayout.addItem(spacerItem13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("Images/Next_Button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.nextButton.setIcon(icon14)
        self.nextButton.setIconSize(QtCore.QSize(100, 75))
        self.nextButton.setObjectName("nextButton")
        self.graphButtonLayout.addWidget(self.nextButton)
        spacerItem14 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.graphButtonLayout.addItem(spacerItem14)
